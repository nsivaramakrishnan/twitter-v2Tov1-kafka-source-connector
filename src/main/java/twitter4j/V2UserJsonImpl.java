 ...
 */
/*package*/ final class V2UserJsonImpl extends TwitterResponseImpl implements User, java.io.Serializable {
    ...
    /*package*/V2UserJsonImpl(HttpResponse res, Configuration conf) throws TwitterException {
        super(res);
    ...
    /*package*/V2UserJsonImpl(JSONObject json) throws TwitterException {
        super();
        init(json);
    }

    /* Only for serialization purposes. */
    /*package*/V2UserJsonImpl() {
