...
public class V2MediaEntityJSONImpl extends EntityIndex implements MediaEntity {
    ...
    V2MediaEntityJSONImpl(JSONObject json) throws TwitterException {
        try {
