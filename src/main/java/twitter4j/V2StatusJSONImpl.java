 ...
 */
/*package*/ final class V2StatusJSONImpl extends TwitterResponseImpl implements Status, java.io.Serializable {
    private static final Logger logger = Logger.getLogger(V2StatusJSONImpl.class);
    ...
    /*package*/V2StatusJSONImpl(HttpResponse res, Configuration conf) throws TwitterException {
        super(res);
    ...
    /*package*/V2StatusJSONImpl(JSONObject json, Configuration conf) throws TwitterException {
        super();
        init(json);
        if (conf.isJSONStoreEnabled()) {
            TwitterObjectFactory.registerJSONObject(this, json);
    ...
    /*package*/ V2StatusJSONImpl(JSONObject json) throws TwitterException {
        super();
        init(json);
    }

    /* Only for serialization purposes. */
    /*package*/ V2StatusJSONImpl() {
    ...
    private void init(JSONObject json) throws TwitterException {
        ...
        try {
            if (!json.isNull("user")) {
                user = new V2UserJsonImpl(json.getJSONObject("user"));
            }
    ...
    private void collectEntities(JSONObject json) throws JSONException, TwitterException {
        if (!json.isNull("entities")) {
            ...
            if (!entities.isNull("media")) {
                ...
                for (int i = 0; i < len; i++) {
                    logger.info("Value of media array:" + mediaArray.getJSONObject(i));
                    mediaEntities[i] = new V2MediaEntityJSONImpl(mediaArray.getJSONObject(i));
                }
            }
        }
    }
